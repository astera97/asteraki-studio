...
export default function CrowdfundingFinalCTASection() {
  return (
        ...
        <div className="relative rounded-[3rem] p-6 sm:p-10 md:p-16 max-w-4xl mx-auto overflow-hidden">
          ...
          <div className="absolute inset-0">
            <div className="relative w-full h-full">
              <Image
                src="/cta_bg.svg"
                alt="Équipe de production de vidéos de financement participatif"
                fill
          ...
          <div className="relative z-10">
            ...
            <div className="max-w-xl">
              <h2 className="text-2xl xs:text-2xl sm:text-2xl lg:text-3xl font-bold leading-tight mb-4 xs:mb-6 sm:mb-8">
                Prêt à lancer votre
              ...
              <p className="text-gray-300 text-base xs:text-lg leading-relaxed mb-6 xs:mb-8 sm:mb-12 max-w-lg">
                Notre équipe se spécialise dans la création de vidéos de financement participatif authentiques qui racontent votre histoire, présentent votre produit et incitent les contributeurs à soutenir votre projet.
              </p>
