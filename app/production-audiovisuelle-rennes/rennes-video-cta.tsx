...
export default function RennesVideoCTASection() { // Updated component name
  return (
        ...
        <div className="relative rounded-[3rem] p-6 sm:p-10 md:p-16 max-w-4xl mx-auto overflow-hidden">
          ...
          <div className="absolute inset-0">
            <div className="relative w-full h-full">
              <Image
                src="/cta_bg.svg"
                alt="Équipe de production audiovisuelle à Rennes"
                fill
          ...
          <div className="relative z-10">
            <div className="max-w-xl">
              ...
              <h2 className="text-3xl xs:text-2xl sm:text-2xl lg:text-4xl font-bold leading-tight mb-6 xs:mb-6 sm:mb-8">
                Votre projet de <span className="text-orange-400">production vidéo à Rennes</span> commence ici
              </h2>
              ...
              <p className="text-gray-300 text-base xs:text-lg leading-relaxed mb-6 xs:mb-8 sm:mb-12 max-w-lg">
                Confiez votre communication vidéo à une équipe qui connaît Rennes et la Bretagne. Nous créons des contenus percutants, livrés en 5 jours, avec plusieurs formats inclus et un ROI clair — sans frais cachés ni mauvaises surprises.
              </p>
