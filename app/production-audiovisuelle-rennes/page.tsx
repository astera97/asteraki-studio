...
import RennesLocationsSection from "./locations"; // Assuming this component is generic enough
import ClientsSection from "@/components/clients-section";
import RennesVideoFAQSection from "./rennes-video-faq"; // Updated import
import RennesVideoCTASection from "./rennes-video-cta"; // Updated import
import ProcessTimelineSection from "./process-section";

export const generateMetadata = async (): Promise<Metadata> => {
  return {
    // Title includes the focus keyword
    title: "Production audiovisuelle à Rennes | Asteraki Studio",
    // Description includes the focus keyword
    description:
      "Expert en production audiovisuelle à Rennes. Vidéos sur mesure pour entreprises bretonnes : institutionnelles, événementielles, recrutement. Livraison rapide, ROI garanti.",
    alternates: {
      canonical: "https://www.asterakistudio.com/production-audiovisuelle-rennes", // Updated canonical
    },
    openGraph: {
      ...
      locale: "fr_FR",
      type: "website",
      url: "https://www.asterakistudio.com/production-audiovisuelle-rennes", // Updated URL
    },
  };
};

export default function RennesVideoProductionPage() { // Updated function name
  return (
    <>
      {/* Schema — updated for Rennes */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "areaServed": ["Rennes", "Bretagne"],
            "serviceType": "Production audiovisuelle",
            "description":
              "Production vidéo professionnelle pour entreprises à Rennes et dans toute la Bretagne : témoignages clients, vidéos institutionnelles, recrutement, couverture d’événements.",
            "offers": {
              "@type": "Offer",
              "businessFunction": "ProvideService",
              "name": "Production audiovisuelle à Rennes" // Updated name
            },
      ...
      <main className="min-h-screen" style={{ backgroundColor: "rgba(255, 255, 255, 1)" }}>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="max-w-xl">
                ...
                <h1 className="text-3xl lg:text-4xl font-bold text-black mb-8 leading-tight">
                  Agence de production vidéo à Rennes pour entreprises bretonnes
                </h1>
                {/* First paragraph of content includes the focus keyword */}
                <p className="text-normal mb-5">
                  Spécialistes de la <strong>production vidéo à Rennes</strong>, nous imaginons des contenus visuels forts pour les entreprises de Bretagne. Que ce soit pour valoriser votre univers, présenter vos services ou capter l'essence d'un événement, notre équipe s'engage à créer des vidéos qui parlent de vous, simplement et efficacement.
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              <div>
                <div className="inline-block px-4 py-1 bg-orange-500/10 text-orange-400 rounded-full text-sm font-medium mb-6">
                  UNE VIDÉO, PLUSIEURS USAGES
                </div>

                <h2 className="text-3xl lg:text-4xl font-bold text-white mb-8">
                  Pourquoi la <span className="text-orange-400">production audiovisuelle à Rennes</span> inclut plusieurs formats pour un marketing efficace
                </h2>
                ...
                <p className="text-white mb-6 leading-relaxed">
                  ...
                  Notre <strong>production audiovisuelle à Rennes</strong> vous fournit des versions optimisées pour maximiser votre impact et votre retour sur investissement.
                </p>
                ...
                <p className="text-white mb-10 leading-relaxed">
                  ...
                  C'est une caractéristique clé de notre <strong>production audiovisuelle à Rennes</strong>, conçue pour répondre aux exigences de votre communication moderne.
                </p>
                ...
                <blockquote className="border-l-4 border-orange-500 pl-6 py-2 mt-10 italic text-gray-300">
                  Chez Asteraki Studio, notre approche de la production audiovisuelle à Rennes va au-delà de la simple création. Nous intégrons dès le départ la stratégie multi-canaux, vous offrant des formats variés sans coût supplémentaire, pour une communication vidéo percutante et homogène.
                </blockquote>
        ...
        {/* Villes */}
        <RennesLocationsSection />

        {/* Client Section */}
        <ClientsSection />

        {/* FAQ */}
        <RennesVideoFAQSection />

        {/* CTA */}
        <RennesVideoCTASection />
      </main>
      <Footer />
    </>
  );
