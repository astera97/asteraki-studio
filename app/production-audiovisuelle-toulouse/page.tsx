...
import ToulouseLocationsSection from "./locations"; // Assuming this component is generic enough
import ClientsSection from "@/components/clients-section";
import ToulouseVideoFAQSection from "./toulouse-video-faq"; // Updated import
import ToulouseVideoCTASection from "./toulouse-video-cta"; // Updated import
import ProcessTimelineSection from "./process-section";

export const generateMetadata = async (): Promise<Metadata> => {
  return {
    // Title includes the focus keyword
    title: "Production audiovisuelle à Toulouse | Asteraki Studio",
    // Description includes the focus keyword
    description:
      "Expert en production audiovisuelle à Toulouse. Vidéos sur mesure pour entreprises : institutionnelles, événementielles, recrutement. Livraison rapide, ROI garanti.",
    alternates: {
      canonical: "https://www.asterakistudio.com/production-audiovisuelle-toulouse", // Updated canonical
    },
    openGraph: {
      ...
      locale: "fr_FR",
      type: "website",
      url: "https://www.asterakistudio.com/production-audiovisuelle-toulouse", // Updated URL
    },
  };
};

export default function ToulouseVideoProductionPage() { // Updated function name
  return (
    <>
      {/* Schema — updated for Toulouse */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "areaServed": ["Toulouse", "Occitanie"],
            "serviceType": "Production audiovisuelle",
            "description":
              "Production vidéo professionnelle pour entreprises à Toulouse et dans toute la région Occitanie : témoignages clients, vidéos institutionnelles, recrutement, couverture d’événements.",
            "offers": {
              "@type": "Offer",
              "businessFunction": "ProvideService",
              "name": "Production audiovisuelle à Toulouse" // Updated name
            },
      ...
      <main className="min-h-screen" style={{ backgroundColor: "rgba(255, 255, 255, 1)" }}>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="max-w-xl">
                ...
                <h1 className="text-3xl lg:text-4xl font-bold text-black mb-8 leading-tight">
                  Production vidéo à Toulouse pour entreprises ambitieuses
                </h1>
                {/* First paragraph of content includes the focus keyword */}
                <p className="text-normal mb-5">
                  Notre agence de <strong>production vidéo à Toulouse</strong> se spécialise dans la création de contenus visuels percutants. Nous collaborons avec des entreprises de la région Occitanie pour produire des vidéos engageantes : événements, témoignages, recrutement, institutionnel. Chaque projet est conçu pour être aligné avec votre vision et vos objectifs.
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              <div>
                ...
                <h2 className="text-3xl lg:text-4xl font-bold text-white mb-8">
                  L'importance de formats multiples dans la <span className="text-orange-400">production audiovisuelle à Toulouse</span>
                </h2>
                ...
                <p className="text-white mb-6 leading-relaxed">
                  ...
                  Notre <strong>production audiovisuelle à Toulouse</strong> vous fournit des versions optimisées pour maximiser votre impact et votre retour sur investissement.
                </p>
                ...
                <p className="text-white mb-10 leading-relaxed">
                  ...
                  C'est une caractéristique clé de notre <strong>production audiovisuelle à Toulouse</strong>, conçue pour répondre aux exigences de votre communication moderne.
                </p>
        ...
        {/* Villes */}
        <ToulouseLocationsSection />

        {/* Client Section */}
        <ClientsSection />

        {/* FAQ */}
        <ToulouseVideoFAQSection />

        {/* CTA */}
        <ToulouseVideoCTASection />
      </main>
      <Footer />
    </>
  );
