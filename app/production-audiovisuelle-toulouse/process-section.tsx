// Define the 3 critical steps with focus on process and timelines - Reworded for Toulouse
const criticalSteps = [
  {
    step: "1",
    title: "Brief & Définition",
  ...
  },
  {
    ...
    desc: "Le tournage s'organise selon vos disponibilités à Toulouse ou en Occitanie. Il est généralement achevé en demi-journée. Le montage est ensuite effectué en interne. Délai : 2 à 3 jours ouvrés post-tournage.",
  },
  {
    step: "3",
