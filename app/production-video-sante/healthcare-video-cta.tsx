        ...
        <div className="relative rounded-[3rem] p-6 sm:p-10 md:p-16 max-w-4xl mx-auto overflow-hidden">
          ...
          <div className="absolute inset-0">
            <div className="relative w-full h-full">
              <Image
                src="/cta_bg.svg"
                alt="Équipe de production vidéo de témoignages patients"
                fill
          ...
          <div className="relative z-10">
            ...
            <div className="max-w-xl">
              <h2 className="text-3xl xs:text-2xl sm:text-2xl lg:text-4xl font-bold leading-tight mb-6 xs:mb-6 sm:mb-8">
                Prêt à améliorer la compréhension
                <span className="text-orange-400 block mt-2">des patients par la vidéo ?</span>
              </h2>

              <p className="text-gray-300 text-base xs:text-lg leading-relaxed mb-6 xs:mb-8 sm:mb-12 max-w-lg">
                Notre équipe se spécialise dans la création de vidéos de santé authentiques qui équilibrent le storytelling compassionnel avec une stricte conformité réglementaire pour renforcer la confiance des patients, expliquer des traitements complexes et améliorer les résultats de santé pour votre organisation de soins.
              </p>
            ...
            <div className="absolute top-9 right-0 xs:top-6 xs:right-4 sm:top-10 sm:right-10 w-10 h-10 xs:w-12 xs:h-12 sm:w-16 sm:h-16 rounded-full overflow-hidden border-2 border-orange-500/30">
              <Image
                ...
                alt="Spécialiste des interviews patients"
                width={64}
                height={64}
