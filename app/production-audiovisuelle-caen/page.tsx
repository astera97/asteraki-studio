...
export const generateMetadata = async (): Promise<Metadata> => {
  return {
    ...
    alternates: {
      canonical: "https://asterakistudio.com/production-audiovisuelle-caen", // Updated canonical
    },
    openGraph: {
      ...
      locale: "fr_FR",
      type: "website",
      url: "https://asterakistudio.com/production-audiovisuelle-caen", // Updated URL
    },
  };
};
