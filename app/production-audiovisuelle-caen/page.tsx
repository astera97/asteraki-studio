...
import NormandieLocationsSection from "./locations"; // Assuming this component is generic enough
import ClientsSection from "@/components/clients-section";
import CaenVideoFAQSection from "./caen-video-faq"; // Updated import
import CaenVideoCTASection from "./caen-video-cta"; // Updated import
import ProcessTimelineSection from "./process-section";

export const generateMetadata = async (): Promise<Metadata> => {
  return {
    // Title includes the focus keyword
    title: "Production audiovisuelle à Caen | Asteraki Studio",
    // Description includes the focus keyword
    description:
      "Expert en production audiovisuelle à Caen. Vidéos sur mesure pour entreprises : institutionnelles, événementielles, recrutement. Livraison rapide, ROI garanti.",
    alternates: {
      canonical: "https://www.asterakistudio.com/production-audiovisuelle-caen", // Updated canonical
    },
    openGraph: {
      ...
      locale: "fr_FR",
      type: "website",
      url: "https://www.asterakistudio.com/production-audiovisuelle-caen", // Updated URL
    },
  };
};

export default function CaenVideoProductionPage() { // Updated function name
  return (
    <>
      {/* Schema — updated for Caen */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description":
              "Production vidéo professionnelle pour entreprises à Caen et dans toute la Normandie : témoignages clients, vidéos institutionnelles, recrutement, couverture d’événements.",
            "offers": {
              "@type": "Offer",
              "businessFunction": "ProvideService",
              "name": "Production audiovisuelle à Caen" // Updated name
            },
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              <div>
                ...
                <p className="text-white mb-6 leading-relaxed">
                  ...
                  Notre <strong>production audiovisuelle à Caen</strong> vous fournit des versions optimisées pour maximiser votre impact et votre retour sur investissement.
                </p>
                ...
                <p className="text-white mb-10 leading-relaxed">
                  ...
                  C'est une caractéristique clé de notre <strong>production audiovisuelle à Caen</strong>, conçue pour répondre aux exigences de votre communication moderne.
                </p>
