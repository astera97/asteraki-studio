      ...
      <div className="max-w-[1000px] mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 sm:mb-8 px-4">
            Présent dans toute la Normandie
          </h2>

          {/* Description */}
          <p className="text-gray-300 text-base sm:text-lg max-w-4xl mx-auto leading-relaxed px-4">
            Notre expertise en production audiovisuelle s'étend à l'ensemble de la région. Basés à Caen, nous intervenons efficacement partout en Normandie — sans frais de déplacement supplémentaires.
          </p>
        </div>
