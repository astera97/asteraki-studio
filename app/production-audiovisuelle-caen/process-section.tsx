// Define the 3 critical steps with focus on process and timelines - Reworded
const criticalSteps = [
  {
    step: "1",
    title: "Compréhension & Stratégie",
    desc: "Nous débutons par un échange approfondi pour cerner vos objectifs et votre public cible. Ensemble, nous définissons la stratégie vidéo et validons le concept. Délai : 1 à 3 jours ouvrés après le premier contact.",
  },
  {
    step: "2",
    title: "Réalisation & Post-Production",
    desc: "Le tournage s'effectue selon vos disponibilités. Il est généralement achevé en demi-journée. Le montage est ensuite réalisé en interne par notre équipe. Délai : 2 à 3 jours ouvrés post-tournage.",
  },
  {
    step: "3",
