...
export const generateMetadata = async (): Promise<Metadata> => {
  return {
    title: "Production audiovisuelle à Paris | Asteraki",
    description:
      "Agence de production audiovisuelle à Paris et en Île-de-France. Vidéos corporate, institutionnelles, événementielles et de recrutement — sur mesure, livrées en 5 jours, avec ROI mesurable.",
    alternates: {
      canonical: "https://www.asteraki.fr/production-audiovisuelle-paris",
    },
    openGraph: {
      title: "Production audiovisuelle à Paris | Asteraki",
      description:
      ...
      locale: "fr_FR",
      type: "website",
      url: "https://www.asteraki.fr/production-audiovisuelle-paris",
    },
  };
};
...
export default function B2BVideoProductionPage() {
  return (
    <>
      {/* Service-Area Business Schema (No Physical Address) */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Asteraki",
            "image": "https://www.asteraki.fr/logo.png",
            "url": "https://www.asteraki.fr/production-audiovisuelle-paris",
            ...
            "description":
              "Agence de production audiovisuelle professionnelle spécialisée dans les vidéos B2B à Paris et dans toute la région Île-de-France : vidéos institutionnelles, témoignages clients, événements, recrutement et plus.",
            "offers": {
              "@type": "Offer",
              "businessFunction": "ProvideService",
              "name": "Production audiovisuelle à Paris"
            },
            "sameAs": [
              "https://www.linkedin.com/company/asteraki"
              // Add other social URLs if needed
            ]
          })
        }}
      />
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="max-w-xl">
                <div className="text-sm font-semibold text-black mb-3 tracking-widest">
                  Production audiovisuelle à Paris
                </div>
                <h1 className="text-3xl lg:text-4xl font-bold text-black mb-8 leading-tight">
                  Production audiovisuelle à Paris pour entreprises ambitieuses
                </h1>
                <p className="text-normal mb-5">
                  Basée en Île-de-France, notre agence Asteraki conçoit des vidéos professionnelles sur mesure pour les entreprises à Paris et dans toute la région. Que ce soit pour un événement corporate, un témoignage client, une vidéo de recrutement ou un message institutionnel, nous livrons un contenu percutant, soigné et 100 % adapté à votre stratégie locale.
                </p>
        ...
        <section className="pt-0 pb-24" style={{ backgroundColor: "rgba(255, 255, 255, 1)" }}>
          <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            <p className="text-center text-black font-normal mt-4 sm:mt-6 text-sm sm:text-base px-4">
              Nous avons accompagné plus de 250 entreprises en France, dont de nombreuses à Paris et en Île-de-France
            </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="max-w-xl">
                ...
                <div className="space-y-6 text-lg text-black leading-relaxed">
                  <p>
                    Nous savons que chaque euro investi en communication doit porter ses fruits. C’est pourquoi nous livrons chaque projet en{" "}
                    <strong>plusieurs formats optimisés</strong> pour tous vos canaux : site web, réseaux sociaux, présentations commerciales, e-mails, et supports internes.
                  </p>
                  <p>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Pas juste une agence de production. <br />
                Une expérience fluide, rapide et sans stress — à Paris et en Île-de-France.
              </p>
            </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        Un message visuel clair capte l’attention 3x plus vite qu’un texte. Idéal pour les décideurs pressés.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        Un format vidéo remplace 10 slides de présentation. Vos équipes gagnent du temps, vos clients comprennent mieux.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        Un seul fournisseur = un seul ton, une seule qualité, partout. Plus de décalage entre vos supports.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        On vous livre plusieurs versions : longue, teaser, sans son, etc. Prêt à diffuser partout.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl mb-8">
                  <div className="aspect-video bg-gray-800 border-2 border-white rounded-2xl overflow-hidden">
                    <video autoPlay loop muted playsInline className="w-full h-full object-cover">
                      <source
                        src="https://py0hr1mf9k.ufs.sh/f/1AsXvEojqztVO0ahUJZW4R1QFJwXPpL9hSmvrajAoYdntbif"
                        type="video/mp4"
                      />
                      Votre navigateur ne supporte pas la balise vidéo.
                    </video>
