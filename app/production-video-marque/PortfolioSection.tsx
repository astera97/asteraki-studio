...
export default function PortfolioSection() {
  const portfolioProjects = [
    ...
    },
    {
      ...
      thumbnail: "https://xb26hl5f9h.ufs.sh/f/myb9AtBX9KywZuPdQK5DmjQM0nVEs2BHNKk8yJeWpug7rf34  ",
    ...
    },
    {
      ...
      title: "Mercury Bank",
      subtitle: "Vidéo de marque",
      description: "Production de la vidéo de marque Mercury, l'art de la finance simplifiée.",
      services: ["Scénario", "Cinématographie", "Intégration VFX", "Étalonnage des couleurs"],
      videoType: "Vidéo de Marque",
      industry: "Finance",
      thumbnail: "https://xb26hl5f9h.ufs.sh/f/myb9AtBX9KywREHDThb8OzUNk9MpYQHDLngqS5jCPli03eFw  ",
    ...
    },
    {
      ...
      title: "Kandji",
      subtitle: "Vidéo de marque",
      description: "Production d'une vidéo de marque pour Kandji mettant en avant leur service Device Harmony.",
      services: ["Scénario", "Cinématographie", "Intégration VFX", "Étalonnage des couleurs"],
      videoType: "Vidéo de Marque",
      industry: "Startup",
      thumbnail: "https://xb26hl5f9h.ufs.sh/f/myb9AtBX9Kywmp7JyRX9KywSWq0Ob7e64m32pHZ8kCQuLAfB  ",
      vimeoUrl: "https://vimeo.com/1110293979  ",
    },
    {
      id: 6,
