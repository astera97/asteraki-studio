...
import NormandieLocationsSection from "./locations";
import ClientsSection from "@/components/clients-section";
import RouenVideoFAQSection from "./rouen-video-faq";
import RouenVideoCTASection from "./rouen-video-cta";
...
export default function RouenVideoProductionPage() {
  return (
    <>
      {/* Schema — valid, clean, service-area based */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description":
              "Production vidéo professionnelle pour entreprises à Rouen et dans toute la Normandie : témoignages clients, vidéos institutionnelles, recrutement, couverture d’événements.",
            "offers": {
              "@type": "Offer",
              "businessFunction": "ProvideService",
              "name": "Production audiovisuelle à Rouen"
            },
            "sameAs": ["https://www.linkedin.com/company/asteraki-studio"]
          })
        }}
      />
      ...
      <main className="min-h-screen" style={{ backgroundColor: "rgba(255, 255, 255, 1)" }}>
        ...
        {/* Client Logos Section — slightly rewritten for authenticity */}
    ...
    <div className="grid lg:grid-cols-2 gap-16 items-start">
      ...
      <div>
        ...
        <h2 className="text-3xl lg:text-4xl font-bold text-white mb-8">
          Pourquoi la <span className="text-orange-400">production audiovisuelle à Rouen</span> inclut plusieurs formats pour un marketing efficace
        </h2>
        ...
        <p className="text-white mb-6 leading-relaxed">
          ...
          Notre <strong>production audiovisuelle à Rouen</strong> vous fournit des versions optimisées pour maximiser votre impact et votre retour sur investissement.
        </p>
        ...
        <p className="text-white mb-10 leading-relaxed">
          ...
          C'est une caractéristique clé de notre <strong>production audiovisuelle à Rouen</strong>, conçue pour répondre aux exigences de votre communication moderne.
        </p>
        ...
        <blockquote className="border-l-4 border-orange-500 pl-6 py-2 mt-10 italic text-gray-300">
          Chez Asteraki Studio, notre approche de la production audiovisuelle à Rouen va au-delà de la simple création. Nous intégrons dès le départ la stratégie multi-canaux, vous offrant des formats variés sans coût supplémentaire, pour une communication vidéo percutante et homogène.
        </blockquote>
      ...
      <div className="relative">
        ...
        {/* Villes */}
        <NormandieLocationsSection />

        {/* Client Section */}
        <ClientsSection />

        {/* FAQ */}
        <RouenVideoFAQSection />

        {/* CTA */}
        <RouenVideoCTASection />
      </main>
      <Footer />
    </>
  );
