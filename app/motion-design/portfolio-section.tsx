...
export default function PortfolioSection() {
  const portfolioProjects = [
    ...
    },
    {
      ...
      title: "Xencelabs",
      subtitle: "Vidéo de marque",
      description: "Présentation du programme de certification Media Buying de TikTok avec du contenu vidéo social engageant.",
      services: ["Scénario", "Cinématographie", "Intégration VFX", "Étalonnage des couleurs"],
      videoType: "Vidéo de Marque",
      industry: "E-commerce",
    ...
    },
    {
      ...
      subtitle: "Vidéo de marque",
      description: "Production d'une vidéo de marque de luxe pour la Girard-Perregaux Laureato Chronograph Ti49",
      services: ["Scénario", "Cinématographie", "Intégration VFX", "Étalonnage des couleurs"],
      videoType: "Vidéo de marque",
      industry: "E-commerce",
