          ...
          <div className="relative z-10">
            ...
            <div className="max-w-xl">
              <h2 className="text-3xl xs:text-2xl sm:text-2xl lg:text-5xl font-bold leading-tight mb-4 xs:mb-6 sm:mb-8">
                Prêt à donner vie à
                <span className="text-orange-400 block mt-2">votre marque grâce au mouvement ?</span>
              </h2>

              <p className="text-gray-300 text-base xs:text-lg leading-relaxed mb-6 xs:mb-8 sm:mb-12 max-w-lg">
                Notre équipe se spécialise dans la création de graphismes animés authentiques qui transforment des concepts statiques en histoires visuelles dynamiques pour captiver votre audience et communiquer efficacement votre message.
              </p>
            ...
            <div className="absolute top-2 right-10 xs:top-6 xs:right-4 sm:top-10 sm:right-10 w-10 h-10 xs:w-12 xs:h-12 sm:w-16 sm:h-16 rounded-full overflow-hidden border-2 border-orange-500/30">
              <Image
            ...
            <div className="absolute top-20 right-5 xs:top-20 xs:right-20 sm:top-40 sm:right-32 w-8 h-8 xs:w-10 xs:h-10 sm:w-14 sm:h-14 rounded-full overflow-hidden border-2 border-orange-500/30">
              <Image
