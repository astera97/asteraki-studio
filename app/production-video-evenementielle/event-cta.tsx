        ...
        <div className="relative rounded-[3rem] p-6 sm:p-10 md:p-16 max-w-4xl mx-auto overflow-hidden">
          ...
          <div className="absolute inset-0">
            <div className="relative w-full h-full">
              <Image
                src="/cta_bg.svg"
                alt="Équipe de production vidéo d'événements"
                fill
          ...
          <div className="relative z-10">
            ...
            <div className="max-w-xl">
              ...
              <p className="text-gray-300 text-base xs:text-lg leading-relaxed mb-6 xs:mb-8 sm:mb-12 max-w-lg">
                Notre équipe se spécialise dans la couverture vidéo professionnelle d'événements qui capture l'énergie, l'émotion et les moments clés de votre conférence, salon professionnel ou rassemblement d'entreprise.
              </p>
