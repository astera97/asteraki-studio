...
import DemoVideoFAQSection from "./demo-video-faq"
import FinalCTASection from "./demo-video-cta"

export const generateMetadata = async () => {
  return {
    title: "Production de vidéos de démonstration | Asteraki",
    description: "Mettez en valeur votre produit avec des vidéos de démonstration professionnelles. Notre équipe crée des démos de produits engageantes qui mettent en avant les fonctionnalités et stimulent les conversions.",
  }
}

export default function DemoVideoProductionPage() {
  return (
    <>
      <Header />
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="max-w-xl">
                <div className="text-sm font-semibold text-black mb-3 tracking-widest">
                  Production de vidéos de démonstration
                </div>
                <h1 className="text-5xl lg:text-6xl font-bold text-black mb-8 leading-tight">
                  Mettez votre produit en valeur sous son meilleur jour.
                </h1>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="max-w-xl">
                <h2 className="text-4xl lg:text-5xl font-bold text-black mb-8 leading-tight">
                  Produit réel. Fonctionnalités réelles. Résultats réels.
                </h2>
                <div className="space-y-6 text-lg text-black leading-relaxed">
                  <p>
                    Les vidéos de démonstration constituent le moyen le plus efficace pour mettre en valeur la valeur de votre produit. Elles montrent comment votre produit fonctionne, mettent en avant les fonctionnalités clés et motivent les spectateurs à essayer ou acheter votre solution, en créant compréhension et confiance auprès des clients potentiels.
                  </p>
                </div>
                <div className="mt-10">
                  <Link href="/contact" passHref>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-20">
              <h2 className="text-4xl lg:text-5xl font-bold text-black mb-4">
                Comment nous garantissons la livraison de vidéos de démonstration<br/> qui favorisent les conversions
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="max-w-xl">
                ...
                <div className="text-lg text-black mb-10 leading-relaxed">
                  <p className="mb-6">
                    Les vidéos de démonstration fonctionnent parce qu'elles montrent plutôt que de raconter. 
                    Lorsque les clients potentiels voient votre produit résoudre de vrais problèmes, 
                    cela crée de la compréhension et de la motivation pour essayer votre solution d'une manière que les captures d'écran statiques ne peuvent jamais atteindre.
                  </p>
                </div>
                <Link href="/contact" passHref>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <p className="text-white mb-8 leading-relaxed">
                  Dans le marché surchargé d'aujourd'hui, les clients n'ont pas le temps de comprendre comment votre produit fonctionne. 
                  Ils doivent le voir en action. Une vidéo de démonstration bien conçue est l'outil le plus efficace 
                  pour mettre en valeur la valeur de votre produit et favoriser les conversions.
                </p>
                
                <p className="text-white mb-10 leading-relaxed">
                  Nos vidéos de démonstration ne se contentent pas de présenter votre produit - elles en démontrent la valeur, 
                  mettent en avant les fonctionnalités clés et créent le « moment d'émerveillement » qui pousse les utilisateurs à agir.
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-white mb-2">Réduit la courbe d'apprentissage</h3>
                      <p className="text-gray-400">Les démonstrations visuelles rendent les fonctionnalités complexes faciles à comprendre, réduisant le temps nécessaire pour que les utilisateurs maîtrisent votre produit.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">Les utilisateurs ont 3,2 fois plus de chances de découvrir et d'utiliser toutes les capacités de votre produit lorsqu'ils les ont vues démontrées dans une vidéo.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">Les pages de destination avec des vidéos de démonstration peuvent augmenter les taux de conversion jusqu'à 80 % par rapport aux pages composées uniquement de texte et d'images.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">Des démonstrations de produits claires par vidéo peuvent réduire les demandes d'assistance client jusqu'à 15 % en répondant aux questions courantes dès le départ.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-white mb-2">Améliore l'intégration des utilisateurs</h3>
                      <p className="text-gray-400">Des vidéos de démonstration efficaces améliorent l'activation et la fidélisation des utilisateurs en rendant l'expérience initiale plus intuitive et engageante.</p>
                    </div>
                  </div>
                </div>
                
                <blockquote className="border-l-4 border-orange-500 pl-6 py-2 mt-10 italic text-gray-300">
                  Chez Asteraki, nous ne créons pas seulement des démos de produits - nous concevons des récits percutants qui transforment les fonctionnalités en avantages tangibles. Laissez-nous vous aider à présenter votre produit sous son meilleur jour.
                </blockquote>
              ...
              <div className="relative">
                ...
                <div className="grid grid-cols-2 gap-6 mt-8">
                  <div className="bg-black/40 rounded-xl p-6 border border-white">
                    ...
                    <p className="text-gray-400 text-sm">Augmentation moyenne de l'adoption des fonctionnalités pour les clients utilisant des vidéos de démonstration professionnelles</p>
                  </div>
                  
                  <div className="bg-black/40 rounded-xl p-6 border border-white">
                    <div className="text-3xl font-bold text-orange-400 mb-2">80%</div>
                    <p className="text-gray-400 text-sm">Taux de conversion plus élevés vs. pages produit avec texte et images uniquement</p>
                  </div>
                  
                  <div className="bg-black/40 rounded-xl p-6 border border-white">
                    <div className="text-3xl font-bold text-orange-400 mb-2">3.2x</div>
                    <p className="text-gray-400 text-sm">Plus de découverte de fonctionnalités vs. documentation écrite</p>
                  </div>
                  
                  <div className="bg-black/40 rounded-xl p-6 border border-white">
                    <div className="text-3xl font-bold text-orange-400 mb-2">250+</div>
                    <p className="text-gray-400 text-sm">Vidéos de démonstration produites pour nos clients</p>
                  </div>
                </div>
