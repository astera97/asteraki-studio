// src/app/production-audiovisuelle-lyon/lyon-video-faq.tsx
"use client";
...
const lyonVideoFAQItems: FAQItem[] = [
  {
  ...
  },
  {
    ...
    answer:
      "Notre processus est simple : un échange pour comprendre votre besoin, un scénario validé par vos soins, le tournage et le montage en interne, et enfin la livraison de plusieurs formats. Cela s'applique à chaque projet de <strong>production audiovisuelle à Lyon</strong> que nous menons à bien.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Notre approche se distingue par la rapidité (livraison en 5 jours), la clarté des tarifs (aucun frais caché), la qualité du rendu (équipe interne), et la flexibilité (nombreux formats inclus). Cela s'applique à chaque projet de <strong>production audiovisuelle à Lyon</strong> que nous menons à bien."
  }
];

export default function LyonVideoFAQSection() { // Updated component name
  ...
  const faqSchema = {
    ...
    "@type": "FAQPage",
    mainEntity: lyonVideoFAQItems.map((item) => ({
      "@type": "Question",
      name: item.question,
      acceptedAnswer: {
        "@type": "Answer",
  ...
  return (
    <>
      ...
      <Script
        id="lyon-video-faq-schema" // Updated schema ID
      ...
      <section className="py-24" style={{ backgroundColor: "#111111" }}>
        <div className="max-w-[1300px] mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            {lyonVideoFAQItems.map((item, index) => (
