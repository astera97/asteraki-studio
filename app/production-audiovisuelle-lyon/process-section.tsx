// Define the 3 critical steps with focus on process and timelines - Reworded for Lyon
const criticalSteps = [
  {
    step: "1",
    title: "Échange & Définition",
    desc: "Un point initial permet de cerner vos besoins et votre cible. Ensemble, nous définissons les contours du projet et validons la direction créative. Délai : 1 à 3 jours ouvrés après le premier contact.",
  },
  {
    step: "2",
    title: "Tournage & Montage",
    desc: "Le tournage s'organise selon vos disponibilités à Lyon ou en Auvergne-Rhône-Alpes. Il est généralement achevé en demi-journée. Le montage est ensuite effectué en interne. Délai : 2 à 3 jours ouvrés post-tournage.",
  },
  {
    step: "3",
