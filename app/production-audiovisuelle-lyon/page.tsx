...
import LyonLocationsSection from "./locations"; // Assuming this component is generic enough
import ClientsSection from "@/components/clients-section";
import LyonVideoFAQSection from "./lyon-video-faq"; // Updated import
import LyonVideoCTASection from "./lyon-video-cta"; // Updated import
import ProcessTimelineSection from "./process-section";

export const generateMetadata = async (): Promise<Metadata> => {
  return {
    // Title includes the focus keyword
    title: "Production audiovisuelle à Lyon | Asteraki Studio",
    // Description includes the focus keyword
    description:
      "Expert en production audiovisuelle à Lyon. Vidéos sur mesure pour entreprises : institutionnelles, événementielles, recrutement. Livraison rapide, ROI garanti.",
    alternates: {
      canonical: "https://www.asterakistudio.com/production-audiovisuelle-lyon", // Updated canonical
    },
    openGraph: {
      ...
      locale: "fr_FR",
      type: "website",
      url: "https://www.asterakistudio.com/production-audiovisuelle-lyon", // Updated URL
    },
  };
};

export default function LyonVideoProductionPage() { // Updated function name
  return (
    <>
      {/* Schema — updated for Lyon */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description":
              "Production vidéo professionnelle pour entreprises à Lyon et dans toute la région Auvergne-Rhône-Alpes : témoignages clients, vidéos institutionnelles, recrutement, couverture d’événements.",
            "offers": {
              "@type": "Offer",
              "businessFunction": "ProvideService",
              "name": "Production audiovisuelle à Lyon" // Updated name
            },
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="max-w-xl">
                ...
                <h1 className="text-3xl lg:text-4xl font-bold text-black mb-8 leading-tight">
                  Production vidéo à Lyon pour entreprises ambitieuses
                </h1>
                {/* First paragraph of content includes the focus keyword */}
                <p className="text-normal mb-5">
                  Notre agence de <strong>production vidéo à Lyon</strong> se spécialise dans la création de contenus visuels percutants. Nous collaborons avec des entreprises de la région Auvergne-Rhône-Alpes pour produire des vidéos engageantes : événements, témoignages, recrutement, institutionnel. Chaque projet est conçu pour être aligné avec votre vision et vos objectifs.
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              <div>
                ...
                <h2 className="text-3xl lg:text-4xl font-bold text-white mb-8">
                  L'importance de formats multiples dans la <span className="text-orange-400">production audiovisuelle à Lyon</span>
                </h2>
                ...
                <p className="text-white mb-6 leading-relaxed">
                  ...
                  Notre <strong>production audiovisuelle à Lyon</strong> vous fournit des versions optimisées pour maximiser votre impact et votre retour sur investissement.
                </p>
                ...
                <p className="text-white mb-10 leading-relaxed">
                  ...
                  C'est une caractéristique clé de notre <strong>production audiovisuelle à Lyon</strong>, conçue pour répondre aux exigences de votre communication moderne.
                </p>
