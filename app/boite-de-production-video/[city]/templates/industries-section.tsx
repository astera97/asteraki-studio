    ...
    <section className="py-16 sm:py-20 lg:py-24 bg-white">
      <div className="max-w-[1000px] mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          {/* Title */}
          <h2 className="text-3xl sm:text-4xl md:text-3xl lg:text-4xl font-bold leading-tight mb-6 sm:mb-8 px-4 text-gray-900">
            Notre agence audiovisuelle a prouvé son impact pour plus de 250 entreprises en France
          </h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
          ...
          {industries.map((industry) => (
            ...
            <Link key={industry.id} href={industry.href} passHref>
              ...
              <div className="relative rounded-xl overflow-hidden cursor-pointer group block border border-gray-200 hover:border-gray-300 transition-colors"> 
