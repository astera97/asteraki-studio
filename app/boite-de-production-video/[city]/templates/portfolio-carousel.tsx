...
const defaultItems: CarouselItem[] = [
  {
    id: "1",
    image: "https://xb26hl5f9h.ufs.sh/f/myb9AtBX9Kywp7yzsFIpEkOY8D0GBumXaioq9CjFLZxsPM1b",
    title: "Framery",
    subtitle: "Brand video",
    videoUrl: "https://vimeo.com/1110297807",
    description: "Production of Framery brand video highlighting their unique story.",
    services: ["Script", "Cinematography", "VFX integration", "Color grading"],
  },
  {
    id: "2",
    image: "https://xb26hl5f9h.ufs.sh/f/myb9AtBX9Kywt87OYL134vBTOxF8dARqINU9EX5yck2foZjG",
    title: "Notion",
    subtitle: "Demo video",
    videoUrl: "https://vimeo.com/1110392859",
    description: "Animated video explaining Notion and its features.",
    services: ["Script", "Cinematography", "VFX integration", "Color grading"],
  },
  {
    id: "3",
    image: "https://xb26hl5f9h.ufs.sh/f/myb9AtBX9KywWPQZ2IUiab8RMjqt25cZzSeDlVIhg1Y3fnXC",
    title: "Remarkable",
    subtitle: "Brand video",
    videoUrl: "https://vimeo.com/1110278295",
    description: "Production of a brand video to introduce the new reMarkable Paper Pro",
    services: ["Script", "Cinematography", "VFX integration", "Color grading"],
  },
  {
    id: "4",
    image: "https://xb26hl5f9h.ufs.sh/f/myb9AtBX9Kyw2MJYAx7LRoDnSIZdyi1KBFNT7vmeUt5Xckg4",
    title: "GIO Insurance",
    subtitle: "Brand video",
    videoUrl: "https://vimeo.com/1110362392",
    description: "Company video highlighting employees reading the customers messages.",
    services: ["Script", "Cinematography", "Motion graphics", "Color grading"],
  },
]
